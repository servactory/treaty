  ...
  class Entity
    module Attribute
      ...
      class Base
        ...
        # Processes helper symbols and options, normalizing them to advanced mode.
        # Also tracks explicitly set options.
        #
        # @param helpers [Array<Symbol>] Helper symbols to process
        # @param options [Hash] User-provided options
        # @return [void]
        def process_options!(helpers, options)
