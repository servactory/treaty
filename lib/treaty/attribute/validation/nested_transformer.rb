  ...
  module Attribute
    module Validation
      ...
      class NestedTransformer
        ...
        # @param root_context [Hash] Full raw data from root level (for computed modifier)
        # @return [Object] Transformed value
        def transform(value, root_context = {})
          return value if value.nil?

          case attribute.type
          when :object
            transform_object(value, root_context)
          when :array
            transform_array(value, root_context)
          else
            value
          end
        end
        ...
        def transform_object(value, root_context = {})
          return value unless attribute.nested?

          transformer = ObjectTransformer.new(attribute)
          transformer.transform(value, root_context)
        end
        ...
        def transform_array(value, root_context = {})
          return value unless attribute.nested?
        ...
        class ObjectTransformer
          ...
          def transform(value, root_context = {})
            ...
            attribute.collection_of_attributes.each do |nested_attribute|
              ...
              process_attribute(nested_attribute, value, transformed, root_context)
            end
          ...
          # @param root_context [Hash] Full raw data from root level (for computed modifier)
          # @return [void]
          def process_attribute(nested_attribute, source_hash, target_hash, root_context = {}) # rubocop:disable Metrics/MethodLength
            ...
            transformed_value = if nested_attribute.nested?
                                  ...
                                  nested_transformer.transform(nested_value, root_context)
                                else
                                  validator.validate_value!(nested_value)
                                  validator.transform_value(nested_value, root_context)
                                end
        ...
        class ArrayTransformer # rubocop:disable Metrics/ClassLength
          ...
          def transform(value, root_context = {})
            value.each_with_index.map do |item, index|
              if simple_array?
                transform_simple_element(item, index, root_context)
              else
                transform_array_item(item, index, root_context)
              end
            end
          end
          ...
          def transform_simple_element(item, index, root_context = {}) # rubocop:disable Metrics/MethodLength
            ...
            begin
              ...
              validator.transform_value(item, root_context)
          ...
          # @return [Hash] Transformed hash
          def transform_array_item(item, index, root_context = {}) # rubocop:disable Metrics/MethodLength
            ...
            attribute.collection_of_attributes.each do |nested_attribute|
              ...
              process_attribute(nested_attribute, item, transformed, index, root_context)
            end
          ...
          # @raise [Treaty::Exceptions::Validation] If validation fails
          # @return [void]
          def process_attribute(nested_attribute, source_hash, target_hash, index, root_context = {}) # rubocop:disable Metrics/MethodLength, Metrics/AbcSize
            source_name = nested_attribute.name
            nested_value = source_hash.fetch(source_name, nil)
