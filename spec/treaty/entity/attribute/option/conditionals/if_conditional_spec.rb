...
RSpec.describe Treaty::Entity::Attribute::Option::Conditionals::IfConditional do
  ...
  describe "#validate_schema!" do
    context "when if option is a Lambda" do
    ...
    context "when if option is a callable object" do
    ...
    context "when if option is not a callable" do
  ...
  describe "#evaluate_condition" do
    ...
    context "with edge cases" do
      context "when lambda returns empty string (truthy in Ruby)" do
        ...
        it "returns true (empty string is truthy)" do
          result = conditional.evaluate_condition(data)
          expect(result).to be(true)
        end
      end
      ...
      context "when lambda returns zero (truthy in Ruby)" do
        ...
        it "returns true (zero is truthy)" do
          result = conditional.evaluate_condition(data)
          expect(result).to be(true)
        end
      end
      ...
      context "when lambda returns empty array (truthy in Ruby)" do
        ...
        it "returns true (empty array is truthy)" do
          result = conditional.evaluate_condition(data)
          expect(result).to be(true)
        end
      end
      ...
      context "when lambda returns empty hash (truthy in Ruby)" do
        ...
        it "returns true (empty hash is truthy)" do
          result = conditional.evaluate_condition(data)
          expect(result).to be(true)
        end
      end
