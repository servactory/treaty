        ...
        module Orchestrator
          ...
          class Base
            ...
            def conditionals_cache
              @conditionals_cache ||= build_conditionals_cache(collection_of_attributes)
            end

            # Returns data for conditional evaluation (implements ConditionalSupport interface)
            # Orchestrator evaluates conditions against the root data
            #
            # @param _source_data [Object] Ignored, uses instance data
            # @return [Hash] Root data for condition evaluation
            def conditional_evaluation_data(_source_data)
              data
            end
