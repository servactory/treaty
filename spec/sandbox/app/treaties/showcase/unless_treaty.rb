...
module Showcase
  class UnlessTreaty < ApplicationTreaty
    version 1 do
      ...
      request do
        object :showcase do
          ...
          string :example2, :optional, unless: ->(showcase:) { showcase[:flag] == true }
        end
      end
    ...
    version 2 do
      ...
      response 200 do
        object :showcase do
          boolean :flag
          string :example1
          string :example2, unless: ->(showcase:) { showcase[:flag] == true }
        end
      end
    ...
    version 3 do
      ...
      request do
        object :showcase do
          boolean :flag, :optional
          string :example1, :optional
          object :nested, :optional, unless: ->(showcase:) { showcase[:flag] == true } do
